"""P1 executable specification, not a production extractor or semantic scorer.

Pure input/output: no source loading, gold, model, persistence or implicit I/O.
Candidate spans are NOT certified atomic propositions. Ambiguity is retained.
"""
