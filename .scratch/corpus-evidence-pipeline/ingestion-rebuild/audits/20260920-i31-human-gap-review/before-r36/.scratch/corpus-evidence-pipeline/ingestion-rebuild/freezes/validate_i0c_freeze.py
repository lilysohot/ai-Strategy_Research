...
# 最新修订绑定优先（supersession）：i0c-r2..r35 显式重绑的路径改由合并后的
# i0c-current 绑定按新哈希核对，i1-r4 中对应旧绑定不再要求匹配。
superseded: set[str] = set()
for sid in ("i0c-r2", "i0c-r3", "i0c-r4", "i0c-r5", "i0c-r6", "i0c-r7", "i0c-r8", "i0c-r9", "i0c-r10", "i0c-r11", "i0c-r12", "i0c-r13", "i0c-r14", "i0c-r15", "i0c-r16", "i0c-r17", "i0c-r18", "i0c-r19", "i0c-r20", "i0c-r21", "i0c-r22", "i0c-r23", "i0c-r24", "i0c-r25", "i0c-r26", "i0c-r27", "i0c-r28", "i0c-r29", "i0c-r30", "i0c-r31", "i0c-r32", "i0c-r33", "i0c-r34", "i0c-r35"):
    entry = by_id.get(sid)
    if not entry:
        continue
