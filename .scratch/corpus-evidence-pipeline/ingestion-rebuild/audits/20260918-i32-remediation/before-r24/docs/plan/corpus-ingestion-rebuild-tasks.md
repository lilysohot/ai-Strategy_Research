...
| I3-2 补料 | [证据目标候选 v5（machine_ready 2／pending_human 20／blocked 2／负例 6；必需 35／补充 4／锚点 15）+ 独立反例 16/16 + 审批件→批准投影→完整性门（no_decisions）；待 U 逐项裁决 40+24+6+1](claims-market-closed-loop-plan.md#i3-2-evidence-candidates) |
...
**I3-2 补料候选已按两轮独立复核整改（2026-09-18 第三轮，A 侧，规则 `evidence-mapping-5`；见总台账
...
| I3-5 | 开发非回归：适用旧检索 golden、财务 57/57、公式 7/7、客户表 12/12、正文 3/3 及正负控，宏观 0/3 另列                  | baseline-bindings | A   | I3-1 后，可与 I3-3 重叠 | I3-1             | 按实际绑定资产核验而非只抄数字；不得删掉仍在范围的旧失败题；此处不是最终版本放行                                       |
