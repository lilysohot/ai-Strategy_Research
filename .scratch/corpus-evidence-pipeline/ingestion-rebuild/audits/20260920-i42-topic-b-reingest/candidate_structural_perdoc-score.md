...
逐类指标（判定按类逐项，不用总体平均掩盖弱类）
  [company] 有答案题 8 | DocRecall@5 宏平均 87.5%（满分 7/8） | QuestionPass 7/8=87.5% | EvidencePass 3/8=37.5%
  ...
  [合计] 类间宏平均（各类等权） DocRecall 95.8% | QuestionPass 95.8% | EvidencePass 50.0%
         题数汇总（非类间平均） QuestionPass 23/24、EvidencePass 12/24
