...
逐类指标（判定按类逐项，不用总体平均掩盖弱类）
  [company] 有答案题 8 | DocRecall@5 宏平均 100.0%（满分 8/8） | QuestionPass 8/8=100.0% | EvidencePass 5/8=62.5%
  ...
  [合计] 类间宏平均（各类等权） DocRecall 100.0% | QuestionPass 100.0% | EvidencePass 70.8%
         题数汇总（非类间平均） QuestionPass 24/24、EvidencePass 17/24
