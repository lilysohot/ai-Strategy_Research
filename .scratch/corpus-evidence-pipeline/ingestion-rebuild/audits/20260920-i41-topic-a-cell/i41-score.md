...
逐类指标（判定按类逐项，不用总体平均掩盖弱类）
  ...
  [industry] 有答案题 8 | DocRecall@5 宏平均 100.0%（满分 8/8） | QuestionPass 8/8=100.0% | EvidencePass 5/8=62.5%
  [macro] 有答案题 8 | DocRecall@5 宏平均 100.0%（满分 8/8） | QuestionPass 8/8=100.0% | EvidencePass 8/8=100.0%
  [合计] 类间宏平均（各类等权） DocRecall 100.0% | QuestionPass 100.0% | EvidencePass 79.2%
         题数汇总（非类间平均） QuestionPass 24/24、EvidencePass 19/24
  负例误报 6 条、伪造引用 6 条（另计，不混入召回分母）

阻断项（存在即不得宣告通过）
  below_threshold:company:evidence_pass=75.0%
  below_threshold:industry:evidence_pass=62.5%
