...
| I3-1 三类 E2E | [照 U 批准集真实执行（6 份 → 可发布 2/6、阻断缺口 13 处、格式覆盖仅 PDF）；判定未完成，两项待 U 裁定；i0c-r32 首次入链](claims-market-closed-loop-plan.md#i3-1-e2e) |
